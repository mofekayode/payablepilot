// Second test invoice. Same vendor as test-invoice-hvac.pdf so the seeded
// Cornerstone HVAC vendor auto-matches, same job reference so the seeded
// project auto-matches, but a different invoice number / date / total so
// it's a fresh document the duplicate-detection logic hasn't seen before.
//
//   node scripts/generate-test-invoice-2.mjs
...
<head>
<meta charset="utf-8" />
<title>Cornerstone HVAC Services · Invoice CHV-5237</title>
<style>
...
<body>
  <div class="top">
    ...
    <div class="meta">
      <h1>INVOICE</h1>
      <div><span class="label">Invoice #:</span> <span class="val">CHV-5237</span></div>
      <div><span class="label">Issue date:</span> <span class="val">2026-04-27</span></div>
      <div><span class="label">Due date:</span> <span class="val">2026-05-27</span></div>
  ...
  <div class="job-banner">
    ...
    <div class="val">Job #JOB-2026-0418 · 418 Maple HVAC Spring Tune-Up · Phase 2 emergency repair</div>
  </div>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>
          <div class="desc">Emergency service call — capacitor replacement, Carrier 38AUZA</div>
          <div class="ref">Job #JOB-2026-0418</div>
        </td>
        <td class="num">1</td>
        <td class="num">$215.00</td>
        <td class="num">$215.00</td>
      </tr>
      <tr>
        <td>
          <div class="desc">Hard-start kit installation</div>
          <div class="ref">Job #JOB-2026-0418</div>
        </td>
        <td class="num">1</td>
  ...
  <div class="totals">
    <div class="row"><span>Subtotal</span><span>$622.50</span></div>
    <div class="row"><span>Tax (8.75%, CA)</span><span>$54.47</span></div>
    <div class="row total"><span>Total due</span><span>$676.97</span></div>
  </div>
...
async function main() {
  ...
  try {
    ...
    const publicOut = join(PUBLIC, "test-invoice-hvac-2.pdf");
    const docsOut = join(DOCS, "test-invoice-hvac-2.pdf");

// Third test invoice. Same Cornerstone HVAC vendor + 418 Maple job so the
// auto-matchers hit, but different invoice number / date / work scope / total
// so the duplicate-detection logic doesn't trip and the user has a fresh
// document to walk through end-to-end.
//
//   node scripts/generate-test-invoice-3.mjs
...
<head>
<meta charset="utf-8" />
<title>Cornerstone HVAC Services · Invoice CHV-5419</title>
<style>
...
<body>
  <div class="top">
    ...
    <div class="meta">
      <h1>INVOICE</h1>
      <div><span class="label">Invoice #:</span> <span class="val">CHV-5419</span></div>
      <div><span class="label">Issue date:</span> <span class="val">2026-04-26</span></div>
      <div><span class="label">Due date:</span> <span class="val">2026-05-26</span></div>
  ...
  <div class="grid2">
    ...
    <div>
      ...
      <div><strong>418 Maple Apartments</strong></div>
      <div>418 Maple St, common areas + units 1A–14C</div>
      <div>Oakland, CA 94609</div>
    </div>
  </div>
  ...
  <div class="job-banner">
    ...
    <div class="val">Job #JOB-2026-0418 · 418 Maple HVAC Spring Tune-Up · annual duct cleaning + MERV upgrade</div>
  </div>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>
          <div class="desc">Whole-building duct cleaning &amp; sanitization (14 units, common areas)</div>
          <div class="ref">418 Maple HVAC Spring Tune-Up · Job #JOB-2026-0418</div>
        </td>
        <td class="num">1</td>
        <td class="num">$1,485.00</td>
        <td class="num">$1,485.00</td>
      </tr>
      <tr>
        <td>
          <div class="desc">MERV 13 filter upgrade — pleated 16x25x4, supply &amp; install</div>
          <div class="ref">418 Maple HVAC Spring Tune-Up · Job #JOB-2026-0418</div>
        </td>
        <td class="num">14</td>
        <td class="num">$32.50</td>
        <td class="num">$455.00</td>
      </tr>
      <tr>
        <td>
          <div class="desc">Coil clean &amp; inspection — package units (rooftop)</div>
          <div class="ref">418 Maple HVAC Spring Tune-Up · Job #JOB-2026-0418</div>
        </td>
        <td class="num">3</td>
        <td class="num">$165.00</td>
        <td class="num">$495.00</td>
      </tr>
      <tr>
        <td>
        ...
        <td class="num">$832.00</td>
      </tr>
    </tbody>
  </table>

  <div class="totals">
    <div class="row"><span>Subtotal</span><span>$3,267.00</span></div>
    <div class="row"><span>Tax (8.75%, CA)</span><span>$285.86</span></div>
    <div class="row total"><span>Total due</span><span>$3,552.86</span></div>
  </div>
...
async function main() {
  ...
  try {
    ...
    const publicOut = join(PUBLIC, "test-invoice-hvac-3.pdf");
    const docsOut = join(DOCS, "test-invoice-hvac-3.pdf");

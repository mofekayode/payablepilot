...
import { emails, invoices, Invoice, EmailThread, InvoiceStatus } from "./app-data";
  ...
  switch (action.type) {
    ...
    case "APPROVE_BATCH":
      return {
        ...
        toast: "Payment batch released to QuickBooks",
      };
    case "TOAST":
...
export function StoreProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(
    () => ({ ...state, readEmail, capture, setStatus, approveBatch, dismissToast, setToast, setArriving, resetDemo }),
    [state, readEmail, capture, setStatus, approveBatch, dismissToast, setToast, setArriving, resetDemo]
  );

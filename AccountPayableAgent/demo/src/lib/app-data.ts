...
export const emails: EmailThread[] = [
  ...
  },
  {
    ...
    bodyParagraphs: [
      "Hi Erin,",
      "Month 2 of the 418 Maple exterior rehab is complete. Progress photos and sign-offs attached along with invoice HB-0422.",
      "Third and final progress invoice will come at punch-list walk.",
      "Hillcrest Builders",
    ],
    receivedAt: "6:12 AM",
    attachment: { name: "HB-0422.pdf", pages: 5 },
...
export const agingReport: AgingRow[] = [
  ...
  { invoiceNumber: "HB-0422", vendorKey: "summit", amount: 3410, issueDate: "2026-04-16", dueDate: "2026-05-16", daysPastDue: -28, bucket: "current" },
  ...
  { invoiceNumber: "HB-0401", vendorKey: "summit", amount: 2100, issueDate: "2026-02-10", dueDate: "2026-03-12", daysPastDue: 37, bucket: "31-60" },
...
export const outbox: OutboxItem[] = [
  ...
  },
  {
    ...
    subject: "Need receiving sign-off for HB-0422",
